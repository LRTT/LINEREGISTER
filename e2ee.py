...
class E2EE:
    ...
    def generateKeypair(self, private_key=None, public_key=None, nonce=None):
        private_key = private_key if private_key else Curve25519.generatePrivateKey(os.urandom(32))
        public_key = public_key if public_key else Curve25519.generatePublicKey(private_key)
    ...
    def calculateSignature(self, private_key, message):
        return Curve25519.calculateSignature(os.urandom(32), private_key, message)
